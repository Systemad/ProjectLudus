...
namespace API.Migrations
{
    ...
    [Migration("20250309222227_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.AlternativeName", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.Collection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.GameLocalization", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.GameMode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.GameType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.LanguageSupport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.Logo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.LudusUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Shared.LudusUserImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Shared.Platform", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.RatingCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.Theme", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.Video", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Shared.AgeRating", b =>
                {
                    ...
                    b.HasOne("Shared.GameMode", "Organization")
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shared.RatingCategory", "RatingCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Shared.Game", b =>
                {
                    ...
                    b.HasOne("Shared.GameType", "GameType")
                        .WithMany()
            ...
            modelBuilder.Entity("Shared.LanguageSupport", b =>
                {
                    ...
                    b.HasOne("Shared.GameMode", "Language")
                        .WithMany()
            ...
            modelBuilder.Entity("Shared.LudusUserImage", b =>
                {
                    b.HasOne("Shared.LudusUser", "LudusUser")
                        .WithOne("LudusUserImage")
                        .HasForeignKey("Shared.LudusUserImage", "LudusUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
