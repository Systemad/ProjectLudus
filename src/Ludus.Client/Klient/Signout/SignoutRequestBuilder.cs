...
namespace Ludus.Client.Signout
{
    ...
    public partial class SignoutRequestBuilder : BaseRequestBuilder
    {
        ...
        public SignoutRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/signout{?returnUrl*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ludus.Client.Signout.SignoutRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SignoutRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/signout{?returnUrl*}", rawUrl)
        {
        }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SignoutRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Ludus.Client.Signout.SignoutRequestBuilder.SignoutRequestBuilderGetQueryParameters>
        {
        }
    }
}
