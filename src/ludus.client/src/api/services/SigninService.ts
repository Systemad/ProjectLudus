...
export interface SigninService {
    get: {
         ...
         * ```ts
         * const { data, isLoading } = qraft.signinService.get.useQuery()
         * ```
         */
         ...
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.signinService.get.useInfiniteQuery({}, {
         *     initialPageParam: {},
         ...
         * ```ts
         * const getTotal = qraft.signinService.get.useIsFetching()
         * ```
         */
         ...
         * ```ts
         * const getResults = qraft.signinService.get.useQueries({
         *     queries: [
         *         {},
         *         {}
         *     ]
         ...
         * ```ts
         * const getCombinedResults = qraft.signinService.get.useQueries({
         ...
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.signinService.get.useSuspenseInfiniteQuery({}, {
         *     initialPageParam: {},
         *     getNextPageParam: (lastPage, allPages, lastPageParam, allPageParams) => getNextPageParams(lastPage)
         * })
         *
         ...
         * ```ts
         * const getData = qraft.signinService.get.useSuspenseQueries({
         *     queries: [
         *         {},
         *         {}
         *     ]
         ...
         * ```ts
         * const getCombinedData = qraft.signinService.get.useSuspenseQueries({
         *     combine: results => results.map(result => result.data),
         *     queries: [
         *         {},
         *         {}
         ...
         * ```ts
         * const data = qraft.signinService.get.useSuspenseQuery()
         * ```
         */
...
export const get = {
    ...
    schema: GetSchema;
    [QraftServiceOperationsToken]: SigninService["get"];
};
