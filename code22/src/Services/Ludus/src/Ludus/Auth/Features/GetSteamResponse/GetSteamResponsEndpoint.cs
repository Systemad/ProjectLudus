...
namespace Ludus.Auth.Features.GetSteamResponse;

public class GetSteamResponsEndpoint : EndpointWithoutRequest<IResult>
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        if (user is null)
        {
            ...
            user = new User
            {
                ...
                SteamId = steamId,
                Role = "Guest", //RoleConstants.DefaultRoleId,
