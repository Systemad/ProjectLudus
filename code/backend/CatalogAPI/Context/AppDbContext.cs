...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<MartMultiplayerMode> MartMultiplayerModes { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5433;Username=postgres;Password=PQDF13*7dpR-Q77nmQZh*3;Database=catalogdev");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder
            .HasPostgresEnum("paradedb", "rangerelation", new[] { "Intersects", "Contains", "Within" })
            .HasPostgresEnum("paradedb", "testtable", new[] { "Items", "Orders", "Parts", "Deliveries", "Customers" })
            .HasPostgresExtension("paradedb", "pg_search")
            .HasPostgresExtension("pg_catalog", "pg_ivm")
        ...
        modelBuilder.Entity<Company>(entity =>
        {
            ...
            entity.HasMany(d => d.Games).WithMany(p => p.Companies)
                .UsingEntity<Dictionary<string, object>>(
                    "CompanyDeveloped",
                    r => r.HasOne<Game>().WithMany()
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("company_developed__dbt_tmp_game_id_fkey"),
                    l => l.HasOne<Company>().WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("company_developed__dbt_tmp_company_id_fkey"),
                    j =>
                    {
                        j.HasKey("CompanyId", "GameId").HasName("company_developed__dbt_tmp_pkey");
                        j.ToTable("company_developed");
                        j.IndexerProperty<long>("CompanyId").HasColumnName("company_id");
                        j.IndexerProperty<long>("GameId").HasColumnName("game_id");
                    });

            entity.HasMany(d => d.GamesNavigation).WithMany(p => p.CompaniesNavigation)
                .UsingEntity<Dictionary<string, object>>(
                    "CompanyPublished",
                    r => r.HasOne<Game>().WithMany()
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("company_published__dbt_tmp_game_id_fkey"),
                    l => l.HasOne<Company>().WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("company_published__dbt_tmp_company_id_fkey"),
                    j =>
                    {
                        j.HasKey("CompanyId", "GameId").HasName("company_published__dbt_tmp_pkey");
                        j.ToTable("company_published");
                        j.IndexerProperty<long>("CompanyId").HasColumnName("company_id");
                        j.IndexerProperty<long>("GameId").HasColumnName("game_id");
                    });
        ...
        modelBuilder.Entity<Game>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Id, e.Name, e.Summary, e.Storyline, e.FirstReleaseDate, e.GameType }, "games_idx22")
                .HasMethod("bm25")
        ...
        modelBuilder.Entity<MartMultiplayerMode>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("mart_multiplayer_modes");
        ...
        modelBuilder.Entity<Theme>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Id, e.Name }, "themes_idx")
                .HasMethod("bm25")
                .HasAnnotation("Npgsql:StorageParameter:key_field", "id");
