...
export const colors = defineSemanticTokens.colors({
    ...
    bg: {
        base: ["white", "neutral.950"],
        contrast: ["black", "white"],
        emphasized: ["black.200", "neutral.700"],
        error: ["error.50", "error.950"],
        float: ["white", "neutral.950"],
        ghost: ["black.50", "neutral.900/50"],
        info: ["info.50", "info.950"],
        muted: ["black.100", "neutral.700"],
        overlay: "blackAlpha.600",
        panel: ["black.bg", "neutral.900"],
        subtle: ["black.50", "neutral.800/50"],
        success: ["success.50", "success.950"],
        warning: ["warning.50", "warning.950"],
    },
    border: {
        base: ["black.100", "neutral.800/70"],
        contrast: ["black", "white"],
        emphasized: ["black.200", "neutral.700/70"],
        error: ["error.500", "error.400"],
        info: ["info.500", "info.400"],
        muted: ["black.100", "neutral.700/70"],
        subtle: ["black.50", "neutral.800/70"],
