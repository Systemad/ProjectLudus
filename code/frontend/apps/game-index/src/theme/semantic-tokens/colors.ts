...
export const colors = defineSemanticTokens.colors({
    ...
    bg: {
        base: ["taupe.200", "neutral.950"],
        contrast: ["black", "white"],
        emphasized: ["taupe.300", "neutral.700"],
        error: ["error.50", "error.950"],
        float: ["taupe.100", "neutral.950"],
        ghost: ["taupe.200/50", "neutral.900/50"],
        info: ["info.50", "info.950"],
        muted: ["taupe.300", "neutral.700"],
        overlay: "blackAlpha.600",
        panel: ["taupe.300", "neutral.900"],
        subtle: ["taupe.300/50", "neutral.800/50"],
        success: ["success.50", "success.950"],
        warning: ["warning.50", "warning.950"],
    },
    border: {
        base: ["taupe.300/80", "neutral.800/70"],
        contrast: ["black", "white"],
        emphasized: ["taupe.400/80", "neutral.700/70"],
        error: ["error.500", "error.400"],
        info: ["info.500", "info.400"],
        muted: ["taupe.300/80", "neutral.700/70"],
        subtle: ["taupe.200/80", "neutral.800/70"],
        success: ["success.500", "success.400"],
        warning: ["warning.500", "warning.400"],
    },
    fg: {
        base: ["taupe.900", "#ededed"],
        contrast: ["#fafafa", "#000000"],
        emphasized: ["taupe.700", "gray.300"],
        error: ["error.500", "error.500"],
        info: ["info.500", "info.500"],
        muted: ["taupe.600", "gray.400"],
        subtle: ["taupe.500", "gray.500"],
    ...
    white: {
        ...
        bg: "neutral.900",
        contrast: "black",
        emphasized: "neutral.700/50",
        fg: "neutral.100",
        ghost: "neutral.800/50",
        muted: "neutral.700/50",
        outline: "neutral.800",
        solid: "white",
        subtle: "neutral.800/50",
    },
