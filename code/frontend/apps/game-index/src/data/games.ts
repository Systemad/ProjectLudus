...
export const spotlightSlides = [
  ...
  },
  {
    ...
    cta: "See campaign",
    image:
      "https://images.unsplash.com/photo-1560419015-7c427e8ae5ba?auto=format&fit=crop&w=1920&q=80",
...
export const anticipatedGames = [
  {
    id: "gta-vi",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuB0XFf8nK_P-y1_qQp_Z8_m_p_r_k_v_X_p_w_x_y_z_0_1_2_3_4_5_6_7_8_9_0_1_2_3_4_5_6_7_8_9_0_1",
  ...
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuA0XFf8nK_P-y1_qQp_Z8_m_p_r_k_v_X_p_w_x_y_z_0_1_2_3_4_5_6_7_8_9_0_1_2_3_4_5_6_7_8_9_0_1_2_3_4_5_6_7_8_9_0_1",
...
export const games: Game[] = [
  ...
  },
  {
    ...
    requirements: {
      minimum: ["OS: 64-bit Windows 7", "Processor: Intel CPU Core i5-2500K", "Memory: 6 GB RAM"],
      recommended: [
...
export const spotlightIndies = [
  {
    ...
    title: "Celeste",
    category: "Platformer",
    subtitle: "A precision platformer built around movement mastery and quiet emotional courage.",
    rating: 4.9,
    image:
  ...
  },
  {
    ...
    subtitle: "A solar system mystery that rewards curiosity and careful observation over combat.",
    rating: 4.8,
    image:
...
export const highestRated = [
  {
    ...
    score: 97,
    image:
      "https://images.unsplash.com/photo-1535223289429-462edb4a5e77?auto=format&fit=crop&w=400&q=80",
  },
  {
