...
export const companiesGetSuspenseQueryKey = ({ companyId }: { companyId: CompaniesGetPathParams["companyId"] }) => ["v1", { url: '/catalog/companies/:companyId', params: {companyId:companyId} }] as const
