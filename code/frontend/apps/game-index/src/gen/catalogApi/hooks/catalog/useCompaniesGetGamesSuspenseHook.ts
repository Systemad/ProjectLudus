...
export const companiesGetGamesSuspenseQueryKey = ({ companyId }: { companyId: CompaniesGetGamesPathParams["companyId"] }) => ["v1", { url: '/catalog/companies/:companyId/games', params: {companyId:companyId} }] as const
