...
public static partial class Log
{
    [LoggerMessage(
        ...
        Message = "Starting SyncWorker at {Time}"
    )]
    ...
    [LoggerMessage(
        EventId = 102,
        Level = LogLevel.Information,
        Message = "Database empty: running initial seeding"
    )]
    ...
    [LoggerMessage(
        EventId = 103,
        Level = LogLevel.Information,
        Message = "Database already seeded: running catchup seeding"
    )]
    ...
    [LoggerMessage(
        EventId = 104,
        Level = LogLevel.Information,
        Message = "Database seeding successful, {Time}"
    )]
    ...
    [LoggerMessage(
        ...
        Message = "Syncing database failed, {Time}: {ErrorMessage}"
    )]
    public static partial void DatabaseSeedingFailed(
        ILogger logger,
        DateTimeOffset time,
        string errorMessage
    );
