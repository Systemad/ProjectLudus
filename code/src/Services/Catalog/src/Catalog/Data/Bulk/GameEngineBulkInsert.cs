...
public class GameEngineBulkInsert : IBulkInsert<GameEngine>
{
    public string CopyCommand =>
        "COPY companies (id, name, slug, url, updated_at, created_at, metadata, logo) FROM STDIN (FORMAT BINARY)";

    public void WriteRow(NpgsqlBinaryImporter writer, GameEngine item)
    {
