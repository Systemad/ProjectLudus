...
export const colors = defineSemanticTokens.colors({
    ...
    bg: {
        base: ["white", "neutral.900"],
        contrast: ["neutral.950", "white"],
        emphasized: ["neutral.800", "white.300"],
        error: ["error.50", "error.950"],
        float: ["white", "neutral.800"],
        ghost: ["neutral.950", "white.50"],
        info: ["info.50", "info.950"],
        muted: ["neutral.900", "white.200"],
        overlay: "blackAlpha.600",
        panel: ["neutral.100", "neutral.800"],
        subtle: ["neutral.950", "white.200/50"],
        success: ["success.50", "success.950"],
        warning: ["warning.50", "warning.950"],
    },
    border: {
        base: ["neutral.900", "white.200/70"],
        contrast: ["neutral.950", "white"],
        emphasized: ["neutral.800", "white.300/70"],
        error: ["error.500", "error.400"],
        info: ["info.500", "info.400"],
        muted: ["neutral.900", "white.200/70"],
        subtle: ["neutral.950", "white.100/70"],
    ...
    neutral: {
        ...
        bg: "neutral.100",
        contrast: "white",
        emphasized: "neutral.800",
        fg: "neutral.200",
        ghost: "neutral.900/50",
        muted: "neutral.900",
        outline: "neutral.100",
        solid: "neutral.950",
        subtle: "neutral.950",
    ...
    gray: {
        base: "gray.500",
        bg: ["neutral.100", "white.bg"],
        contrast: ["white", "white"],
        emphasized: ["neutral.800", "white.400/50"],
        fg: ["neutral.200", "white.900"],
        ghost: ["neutral.900/50", "white.200/50"],
        muted: ["neutral.900", "white.300/50"],
        outline: ["neutral.100", "white.800"],
    ...
    cyan: {
        ...
        contrast: ["neutral.950", "neutral.950"],
