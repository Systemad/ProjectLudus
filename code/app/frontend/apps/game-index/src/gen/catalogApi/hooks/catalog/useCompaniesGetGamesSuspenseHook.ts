...
export const companiesGetGamesSuspenseQueryKey = ({ companyId }: { companyId: CompaniesGetGamesPathParams["companyId"] | undefined }) => ["v1", { url: '/catalog/companies/:companyId/games', params: {companyId:companyId} }] as const
