...
export const gamesGetOverviewSuspenseQueryKey = ({ gameId }: { gameId: GamesGetOverviewPathParams["gameId"] | undefined }) => ["v1", { url: '/catalog/games/:gameId', params: {gameId:gameId} }] as const
