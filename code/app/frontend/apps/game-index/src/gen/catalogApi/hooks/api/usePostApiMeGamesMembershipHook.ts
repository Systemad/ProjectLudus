...
import type { PostApiMeGamesMembershipOptions, PostApiMeGamesMembershipStatus200, PostApiMeGamesMembershipStatus400 } from '../../types/ListsTypes/PostApiMeGamesMembership'
...
export function postApiMeGamesMembershipMutationOptionsHook<TContext = unknown>(config: Partial<Omit<RequestConfig, 'path' | 'query' | 'body' | 'headers' | 'url'>> = {}) {
 ...
 */
export function usePostApiMeGamesMembershipHook<TContext>(options: {
  ...
  const baseOptions = postApiMeGamesMembershipMutationOptionsHook(config) as UseMutationOptions<PostApiMeGamesMembershipStatus200, ResponseErrorConfig<PostApiMeGamesMembershipStatus400>, PostApiMeGamesMembershipOptions, TContext>
