...
export type GameCoverCardVariant = "grid" | "rail" | "cover";
...
type GameCoverCardProps = {
  ...
  imageUrl?: string;
  href: Href;
  variant: GameCoverCardVariant;
};

export function GameCoverCard({ title, metadata, imageUrl, href, variant }: GameCoverCardProps) {
