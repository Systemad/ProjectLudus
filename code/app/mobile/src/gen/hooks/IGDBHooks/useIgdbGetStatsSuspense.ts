...
export function igdbGetStatsSuspenseQueryOptions(config: Partial<Omit<RequestConfig, 'path' | 'query' | 'body' | 'headers' | 'url'>> = {}) {
 ...
 */
export function useIgdbGetStatsSuspense<TData = IgdbGetStatsStatus200, TQueryKey extends QueryKey = IgdbGetStatsSuspenseQueryKey>(options: {
  ...
  const queryResult = useSuspenseQuery({
   ...igdbGetStatsSuspenseQueryOptions(config),
   ...resolvedOptions,
   queryKey,
