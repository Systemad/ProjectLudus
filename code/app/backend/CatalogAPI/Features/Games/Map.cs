using CatalogAPI.Features.Games.Browse.GetByReleaseDateRange;
using Endpoint = CatalogAPI.Features.Games.Browse.GetByReleaseDateRange.Endpoint;
...
public static class Map
{
    public static IEndpointRouteBuilder MapGamesFeature(this IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .Produces<GetByReleaseDateRangeResponse>(
        ...
        group
            ...
            .WithTags(EndpointMetadata.Games)
            .Produces<Page.GetReleaseData.GetGamePageReleaseDataResponse>(
                StatusCodes.Status200OK
            )
            .Produces(StatusCodes.Status404NotFound);
