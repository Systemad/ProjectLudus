import { Flex, Box, Button, Text } from "@packages/ui";
...
const ALL_SORT_ITEMS = [
    RELEVANCY_SORT_ITEM,
    ...SORT_ANCHOR_OPTIONS.filter(
        (option) => option.value !== "relevancy"
    ).flatMap((anchor) =>
                ...
                <Flex gap="xs" wrap="wrap">
                    {SORT_ANCHOR_OPTIONS.map((option) => (
                        <Button
                            ...
                            size="sm"
                            variant={
                                anchor === option.value ? "solid" : "outline"
                            }
                            onClick={() => {
                                ...
                                refine(
                                    `games_search/sort/${option.value}:${direction}`
                                );
                            }}
                        >
                            {option.label}
                ...
                <Flex gap="xs" wrap="wrap">
                    {SORT_DIRECTION_OPTIONS.map((option) => (
                        <Button
                            ...
                            size="sm"
                            variant={
                                direction === option.value && isReplicaSort
                                    ? "solid"
                                    : "outline"
                            }
                            ...
                            onClick={() => {
                                ...
                                refine(
                                    `games_search/sort/${anchor}:${option.value}`
                                );
                            }}
                        >
                            {option.label}
