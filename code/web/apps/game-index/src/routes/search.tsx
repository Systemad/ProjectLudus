                        ...
                        <ScrollArea maxH="sm" pr="xs">
                            <CheckboxCardGroup.Root
                                ...
                                onChange={(values: string[]) => {
                                    ...
                                    items.forEach((item) => {
                                        const shouldBeRefined = nextSet.has(
                                            item.value
                                        );

                                        if (
                                            shouldBeRefined !== item.isRefined
                                        ) {
                                            refine(item.value);
                                        }
                                    });
...
function HitCard({ hit }: { hit: GameSearchHit }) {
    ...
    const rating =
        typeof hit.aggregated_rating === "number"
            ? Math.round(hit.aggregated_rating)
            : null;
                    ...
                    <Box minW={0}>
                        ...
                        <Pagination
                            classNames={{
                                ...
                                selectedItem:
                                    "typesense-pagination-item--selected",
